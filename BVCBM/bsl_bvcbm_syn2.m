...
load('cov_matrix_syn2.mat');
cov_rw = cov_rm;

Y = sim2; theta_true = param2;
...
%%
tic;
[theta,dist] = bsl_bvcbm(Y,init,m,M,cov_rw,prior,'res/bsl_syn2_');
finaltime=toc;


save('res/results_bsl_syn2.mat','theta','dist','finaltime');