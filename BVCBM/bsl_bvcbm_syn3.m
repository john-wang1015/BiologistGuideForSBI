...
load('cov_matrix_syn3.mat');
cov_rw = cov_rm;

Y = sim3; theta_true = param3;
...
%%
tic;
[theta,dist] = bsl_bvcbm(Y,init,m,M,cov_rw,prior,'res/bsl_syn3_');
finaltime=toc;


save('res/results_bsl_syn3.mat','theta','dist','finaltime');