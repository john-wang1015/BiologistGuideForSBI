...
def get_model(true_params=None, x_obs=None):
    if true_params is None:
        true_params = np.array([500.0, 200.0,  9.0])
...
def run_rbsl():
    ...
    res.plot_traces()
    plt.savefig('rbsl_bvcbm_traces_pan2.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('rbsl_bvcbm_marginals_pan2.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('rbsl_bvcbm_pairs_pan2.png')


    folder_name = "res/rbsl/pan2"
    ...
    plt.savefig('rbsl_bvcbm_gamma_pan2.png')
