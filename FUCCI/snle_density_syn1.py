...
def run_snle():
    x_0 = sio.loadmat('CellDensity_synthetic_dataset.mat')['sy1']
    theta_true = sio.loadmat('CellDensity_synthetic_dataset.mat')['theta1']
    ...
    folder_name = "res/nle/fucci_syn1_density"
    ...
    for kk in range(num_rounds):
        ...
        mat_path = os.path.join(folder_name, "snle_c_nsf fucci syn1 density, round {}.mat".format(kk))
        ...
        pic_path = os.path.join(folder_name, 'snle_fucci_syn1_density_iteration {}.png'.format(kk))
    ...
    for idx, model in enumerate(posteriors):
        file_path = os.path.join(folder_name, 'fucci_syn1_density_model_{idx}.pth')
