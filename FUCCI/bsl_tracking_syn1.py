...
def run_bsl():
    folder_name = "res/bsl/syn1_tracking"
    is_exist = os.path.exists(folder_name)
    if not is_exist:
        os.makedirs(folder_name)

    true_params = sio.loadmat('CellTracking_synthetic_dataset.mat')['theta1']
    x_obs = sio.loadmat('CellTracking_synthetic_dataset.mat')['sy1']
