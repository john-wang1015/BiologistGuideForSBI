...
def run_snle():
    x_0 = sio.loadmat('CellDensity_synthetic_dataset.mat')['sy2']
    theta_true = sio.loadmat('CellDensity_synthetic_dataset.mat')['theta2']
    ...
    folder_name = "res/nle/fucci_syn2_density"
    ...
    for kk in range(num_rounds):
        ...
        mat_path = os.path.join(folder_name, "snle_c_nsf fucci syn2 density, round {}.mat".format(kk))
        ...
        pic_path = os.path.join(folder_name, 'snle_fucci_syn2_density_iteration {}.png'.format(kk))
    ...
    for idx, model in enumerate(posteriors):
        file_path = os.path.join(folder_name, 'fucci_syn2_density_model_{idx}.pth')
