...
%load('res/results_SMCABC_tracking_syn3.mat')
load('res/tracking_syn4_progress23.mat','theta_trans')
theta_smc = [TransformationFun(theta_trans(:,1:3),1,true),TransformationFun(theta_trans(:,4:6),10,true)];

load('res/snpe_c_nsf fucci syn4 tracking, round 9.mat')
theta_snpe = double(posterior);

load('res/snle_c_nsf fucci syn4 tracking, round 9.mat')
...
save('res/tracking_syn4_posterior_predictive_results.mat');
