...
load('res/snpe_c_nsf fucci syn3 tracking, round 9.mat')
theta_snpe = double(posterior);

load('res/snle_c_nsf fucci syn3 tracking, round 9.mat')
...
save('res/tracking_syn3_posterior_predictive_results.mat');
