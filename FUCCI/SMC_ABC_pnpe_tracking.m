function SMC_ABC_pnpe_tracking
    ...
    while p_accept > pacc_target && tolmax > tol_target
        ...
        save(sprintf('res/smcabc/pnpe_tracking%d.mat',tt),'theta_trans', 'p_accept','tolmax','p_unique', "count"); %write performance stats to excel
