...
def run_snle():
    ...
    folder_name = "res/nle/fucci_syn3_density"
    ...
    for kk in range(num_rounds):
        ...
        mat_path = os.path.join(folder_name, "snle_c_nsf fucci syn3 density, round {}.mat".format(kk))
        ...
        pic_path = os.path.join(folder_name, 'snle_fucci_syn3_density_iteration {}.png'.format(kk))
