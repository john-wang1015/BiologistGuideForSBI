function SMC_ABC_density_syn1
    ...
    load('CellDensity_synthetic_dataset.mat','sy1');%[Nred, Nyellow, Ngreen, TotalDistance]; %store observed summary statistics
    sy = sy1;
    ...
    while p_accept > pacc_target && tolmax > tol_target
        ...
        save(sprintf('res/smcabc/density_syn1_progress%d.mat',tt),'theta_trans', 'p_accept','tolmax','p_unique'); %write performance stats to excel
    end
...
%% save results   
    ...
    filename = sprintf('res/smcabc/results_SMCABC_density_syn1.mat');
