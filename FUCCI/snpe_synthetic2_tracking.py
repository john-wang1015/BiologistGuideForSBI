...
def run_snpe_c():
    ...
    folder_name = "res/npe/fucci_syn2_tracking"
    ...
    for kk in range(num_rounds):
        ...
        mat_path = os.path.join(folder_name, "snpe_c_nsf fucci syn2 tracking, round {}.mat".format(kk))
        ...
        pic_path = os.path.join(folder_name, 'snpc_fucci_syn2_tracking_iteration {}.png'.format(kk))
