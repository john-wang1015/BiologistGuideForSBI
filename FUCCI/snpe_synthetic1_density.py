...
def run_snpe_c():
    ...
    folder_name = "res/npe/fucci_syn1_density"
    ...
    for kk in range(num_rounds):
        ...
        mat_path = os.path.join(folder_name, "snpe_c_nsf fucci syn1 density, round {}.mat".format(kk))
        ...
        pic_path = os.path.join(folder_name, 'snpc_fucci_syn1_density_iteration {}.png'.format(kk))
