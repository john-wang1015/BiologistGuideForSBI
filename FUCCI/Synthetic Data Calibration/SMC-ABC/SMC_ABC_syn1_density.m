...
% 
    ...
    %load data
    InitPosData = readmatrix("Data/FUCCI_processed.xlsx", "sheet","InitPos");
    FinalPosData = readmatrix("Data/FUCCI_processed.xlsx", "sheet","FinalPos");
    CellTrackingData = readmatrix("Data/FUCCI_processed.xlsx", "sheet","CellTracking");
    ...
    %%
    load('Data/syntheticData1_cellDensity.mat');
...
%% save results   
    ...
    filename = sprintf('results_SMCABC_density_syn%d.mat',1);
