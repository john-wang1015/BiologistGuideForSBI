function SMC_ABC_tracking_syn2
    ...
    load('CellTracking_synthetic_dataset.mat','sy2');%[Nred, Nyellow, Ngreen, TotalDistance]; %store observed summary statistics
    sy = sy2;
    ...
    while p_accept > pacc_target && tolmax > tol_target
        ...
        save(sprintf('res/smcabc/tracking_syn2_progress%d.mat',tt),'theta_trans', 'p_accept','tolmax','p_unique'); %write performance stats to excel
    end
...
%% save results   
    ...
    filename = sprintf('res/smcabc/results_SMCABC_tracking_syn2.mat');
