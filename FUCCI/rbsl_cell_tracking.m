function [theta,loglike,gamma] = rbsl_cell_tracking(ssy,n,M,cov_rw,start,reg_mean,file_name)
...
parfor (k = 1:n,ncpus)
    k
    ssx(k,:) = simulator_tracking_nonparall(init, 6, InitPosData, CellTrackingData);
end
