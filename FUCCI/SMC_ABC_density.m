function SMC_ABC_density
    ...
    while p_accept > pacc_target && tolmax > tol_target
        ...
        save(sprintf('res/smcabc/real_density%d.mat',tt),'theta_trans', 'p_accept','tolmax','p_unique',"count"); %write performance stats to excel
...
%% save results   
    ...
    filename = sprintf('results_SMCABC_real_track%d.mat',ntrack);
