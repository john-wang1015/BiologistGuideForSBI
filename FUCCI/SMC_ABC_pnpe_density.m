function SMC_ABC_pnpe_density
    ...
    while p_accept > pacc_target && tolmax > tol_target
        ...
        save(sprintf('res/smcabc/pnpe_density%d.mat',tt),'theta_trans', 'p_accept','tolmax','p_unique',"count"); %write performance stats to excel
