function SMC_ABC_tracking_syn3
    ...
    load('CellTracking_synthetic_dataset.mat','sy3');%[Nred, Nyellow, Ngreen, TotalDistance]; %store observed summary statistics
    sy = sy3;
    ...
    while p_accept > pacc_target && tolmax > tol_target
        ...
        save(sprintf('res/smcabc/tracking_syn3_progress%d.mat',tt),'theta_trans', 'p_accept','tolmax','p_unique'); %write performance stats to excel
    end
...
%% save results   
    ...
    filename = sprintf('res/smcabc/results_SMCABC_tracking_syn3.mat');
