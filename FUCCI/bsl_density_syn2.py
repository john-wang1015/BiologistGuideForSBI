...
def run_bsl():
    folder_name = "res/bsl/syn2_density"
    is_exist = os.path.exists(folder_name)
    if not is_exist:
        os.makedirs(folder_name)

    x_obs = sio.loadmat('CellDensity_synthetic_dataset.mat')['sy2']
    true_params = sio.loadmat('CellDensity_synthetic_dataset.mat')['theta2']
