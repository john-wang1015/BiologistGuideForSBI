...
def run_rbsl():
    ...
    res.plot_traces()
    plt.savefig('rbslv_bvcbm_traces_syn1.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('rbslv_bvcbm_marginals_syn1.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('rbslv_bvcbm_pairs_syn1.png')
    ...
    plt.savefig('rbslv_bvcbm_gamma_syn1.png')
