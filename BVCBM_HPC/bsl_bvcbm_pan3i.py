...
def run_rbsl():
    ...
    est_posterior_cov = sio.loadmat("cov_matrix_pan3.mat")['cov_matrix']
    ...
    res.plot_traces()
    plt.savefig('bsl_bvcbm_traces_pan3i.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('bsl_bvcbm_marginals_pan3i.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('bsl_bvcbm_pairs_pan3i.png')

    folder_name = "res/bsl/pan3i"
    ...
    plt.savefig('bsl_bvcbm_gamma_pan3i.png')
