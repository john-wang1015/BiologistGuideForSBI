...
def run_rbsl():
    obs = sio.loadmat("paper2_BVCBM_synthetic_datasets.mat")['sim1']
    ...
    est_posterior_cov = sio.loadmat("cov_matrix_syn1.mat")['subset_matrix']
    ...
    res.plot_traces()
    plt.savefig('bslv_bvcbm_traces_syn1i.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('bslv_bvcbm_marginals_syn1i.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('bslv_bvcbm_pairs_syn1i.png')
    ...
    plt.savefig('bslv_bvcbm_gamma_syn1i.png')

    folder_name = "res/bsl/syn1i"
