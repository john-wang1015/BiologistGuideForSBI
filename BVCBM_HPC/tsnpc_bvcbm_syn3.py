...
def run_snpe_c():
    ...
    for kk in range(num_rounds):
        ...
        posterior_sample = posterior.sample((10000,), x=x_0)
        ...
        plt.savefig('tsnpc_bvcbm_syn3_iteration {}.png'.format(kk))
        plt.show()
        
        string2save = "tsnpe_c_nsf syn3, round {}.mat".format(kk)
