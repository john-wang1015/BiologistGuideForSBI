...
def run_rbsl():
    ...
    res.plot_traces()
    plt.savefig('bsl_bvcbm_traces_pan4.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('bsl_bvcbm_marginals_pan4.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('bsl_bvcbm_pairs_pan4.png')

    folder_name = "res/bsl/pan4"
    ...
    plt.savefig('bsl_bvcbm_gamma_pan4.png')
