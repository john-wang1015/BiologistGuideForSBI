...
def run_rbsl():
    ...
    res.plot_traces()
    plt.savefig('rbsl_bvcbm_traces_pan3.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('rbsl_bvcbm_marginals_pan3.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('rbsl_bvcbm_pairs_pan3.png')

    folder_name = "res/rbsl/pan3"
    ...
    plt.savefig('rbsl_bvcbm_gamma_pan3.png')
