...
def run_rbsl():
    ...
    res.plot_traces()
    plt.savefig('rbslv_bvcbm_traces_syn2.png')


    mbins = 30
    res.plot_marginals(reference_value=true_params,
                       bins=mbins)
    plt.savefig('rbslv_bvcbm_marginals_syn2.png')

    res.plot_pairs(reference_value=true_params,
                   bins=mbins)
    plt.savefig('rbslv_bvcbm_pairs_syn2.png')
    ...
    plt.savefig('rbslv_bvcbm_gamma_syn2.png')

    folder_name = "res/bsl/syn2"
