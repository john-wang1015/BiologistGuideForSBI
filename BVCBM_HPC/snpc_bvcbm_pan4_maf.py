...
def run_snpe_c():
    x_0 = sio.loadmat("CancerDatasets.mat")['Pancreatic_4th_mouse_data'].reshape(32)
    ...
    for kk in range(num_rounds):
        ...
        plt.savefig('snpc_bvcbm_pan4_maf_iteration {}.png'.format(kk))
        plt.show()

        string2save = "snpe_c_maf pan4, round {}.mat".format(kk)
