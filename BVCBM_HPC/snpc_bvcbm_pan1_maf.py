...
def run_snpe_c():
    ...
    for kk in range(num_rounds):
        ...
        plt.savefig('snpc_bvcbm_pan1_maf_iteration {}.png'.format(kk))
        plt.show()
        
        string2save = "snpe_c_maf pan1, round {}.mat".format(kk)
